 ...
 */
public class ChainedProxyWithFallbackToOtherChainedProxyDueToSSLTest
        extends BadServerAuthenticationTCPChainedProxyTest {
    @Override
    ...
    protected ProxyChainManager proxyChainManager() {
        return new ProxyChainManager() {
            ...
            public void lookupProxyChain(ProxyChainContext proxyChainContext) {
                ...
                proxyChainContext.getProxyChains().add(new BaseChainedProxy() {
                    @Override
