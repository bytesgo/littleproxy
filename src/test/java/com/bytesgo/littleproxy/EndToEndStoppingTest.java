...
public class EndToEndStoppingTest {
	...
	/**
	 * This is a quick test from nasis that exhibits different behavior from unit
	 * tests because unit tests call System.exit(). The stop method should stop all
	 * non-daemon threads and should cause the JVM to exit without explicitly
	...
	private void runSiteTestWithHttpClient(final String site) throws Exception {
		...
		/*
		 * final HttpProxyServer ssl = new DefaultHttpProxyServer(PROXY_PORT, null,
		 * null, new SslHandshakeHandlerFactory(), new HttpRequestFilter() {
		 * 
