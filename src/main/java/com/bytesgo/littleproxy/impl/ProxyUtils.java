...
public class ProxyUtils {
   ...
   * (http://www.w3.org/Protocols/rfc2616/rfc2616-sec13.html#sec13.5.1). Transfer-Encoding is NOT included in this list,
  ...
  private static final Set<String> SHOULD_NOT_PROXY_HOP_BY_HOP_HEADERS =
      ImmutableSet.of(HttpHeaderNames.CONNECTION.toLowerCase().toString(), HttpHeaderNames.PROXY_AUTHENTICATE.toLowerCase().toString(),
          HttpHeaderNames.PROXY_AUTHORIZATION.toLowerCase().toString(), HttpHeaderNames.TE.toLowerCase().toString(),
           ...
           */
          HttpHeaderNames.UPGRADE.toLowerCase().toString(), "Keep-Alive".toLowerCase(Locale.US));
   ...
   * the same as "connection" or "CONNECTION". From http://www.w3.org/Protocols/rfc2616/rfc2616-sec13.html#sec13.5.1 :
   * 
   * <pre>
