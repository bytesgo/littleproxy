 ...
 * {@link LastHttpContent} and can be checked for being last using {@link ProxyUtil#isLastChunk(HttpObject)}.
 * </p>
 * 
 * <p>
 * {@link HttpFilterSource#getMaximumRequestBufferSizeInBytes()} and
 * {@link HttpFilterSource#getMaximumResponseBufferSizeInBytes()} can be used to instruct the proxy to buffer the
 ...
 * 
 * <p>
 * A new instance of {@link HttpFilter} is created for each request, so these objects can be stateful.
 * </p>
 * 
 * <p>
