 ...
 * 
 * <p>
 * Sub-classes may wish to extend {@link ProxyChainAdapter} for sensible defaults.
 * </p>
 */
public interface ProxyChain extends SslEngineSource {
  /**
  ...
  /**
   * Implement this method to tell LittleProxy whether or not to encrypt connections to the chained proxy for the given
   * request. If true, LittleProxy will call {@link SslEngineSource#newSslEngine()} to obtain an SSLContext used by the
   * downstream proxy.
   * 
   ...
   * 
   * @param cause exception that caused this failure (may be null)
   */
