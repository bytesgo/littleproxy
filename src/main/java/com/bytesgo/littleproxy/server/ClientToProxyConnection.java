...
import static com.bytesgo.littleproxy.model.enums.ConnectionState.AWAITING_PROXY_AUTHENTICATION;
import static com.bytesgo.littleproxy.model.enums.ConnectionState.DISCONNECT_REQUESTED;
import static com.bytesgo.littleproxy.model.enums.ConnectionState.NEGOTIATING_CONNECT;
...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest> {
    ...
    public ClientToProxyConnection(final DefaultHttpProxyServer proxyServer, SslEngineSource sslEngineSource,
            boolean authenticateClients, ChannelPipeline pipeline,
    ...
    protected ConnectionState readHTTPInitial(HttpRequest httpRequest) {
        ...
        if (httpRequest.decoderResult().isFailure()) {
            ...
            FullHttpResponse response = ProxyUtil.createFullHttpResponse(HttpVersion.HTTP_1_1,
    ...
    private void closeConnectionsAfterWriteIfNecessary(ProxyToServerConnection serverConnection,
        ...
        boolean closeServerConnection = shouldCloseServerConnection(currentHttpRequest, currentHttpResponse,
                httpObject);
        boolean closeClientConnection = shouldCloseClientConnection(currentHttpRequest, currentHttpResponse,
                httpObject);
