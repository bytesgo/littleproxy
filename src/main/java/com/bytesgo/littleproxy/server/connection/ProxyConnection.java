...
public abstract class ProxyConnection<I extends HttpObject> extends SimpleChannelInboundHandler<Object> {
	 ...
	 * @param proxyServer     the {@link DefaultHttpProxyServer} in which we're
	 *                        running
	 ...
	 * </p>
	 */
	protected ConnectionFlowStep<Void> StartTunneling = new ConnectionFlowStep<Void>(this, ConnectionState.NEGOTIATING_CONNECT) {
		@Override
