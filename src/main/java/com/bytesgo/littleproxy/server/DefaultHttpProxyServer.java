...
public class DefaultHttpProxyServer implements HttpProxyServer {
	 ...
	 *                                    encrypt inbound connections from clients
	 *                                    using an {@link SSLEngine} obtained from
	 *                                    this {@link SslEngineSource}.
	 * @param authenticateSslClients      Indicate whether or not to authenticate
	 *                                    clients when using SSL
	 * @param proxyAuthenticator          (optional) If specified, requests to the
	 *                                    proxy will be authenticated using HTTP
	 *                                    BASIC authentication per the provided
	 ...
	 *                                    the middle'ing CONNECT requests
	 ...
	 *                                    the origin server (to comply with RFC 7230
	 *                                    section 5.3.1).
	 ...
	 */
	public DefaultHttpProxyServer(ServerGroup serverGroup, TransportProtocol transportProtocol, InetSocketAddress requestedAddress,
		...
		if (writeThrottleBytesPerSecond > 0 || readThrottleBytesPerSecond > 0) {
			this.globalTrafficShapingHandler = createGlobalTrafficShapingHandler(transportProtocol, readThrottleBytesPerSecond,
