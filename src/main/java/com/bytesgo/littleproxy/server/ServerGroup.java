...
public class ServerGroup {
	 ...
	 */
	private final EnumMap<TransportProtocol, ProxyThreadPool> protocolThreadPools = new EnumMap<TransportProtocol, ProxyThreadPool>(
	 ...
	 */
	private static final EnumMap<TransportProtocol, SelectorProvider> TRANSPORT_PROTOCOL_SELECTOR_PROVIDERS = new EnumMap<TransportProtocol, SelectorProvider>(
			TransportProtocol.class);
	static {
