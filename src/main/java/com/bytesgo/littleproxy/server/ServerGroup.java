...
public class ServerGroup {
  ...
  /**
   * A mapping of {@link TransportProtocol}s to their initialized {@link ProxyThreadPool}. Each transport uses a different
   * thread pool, since the initialization parameters are different.
   */
