...
/**
 * Configuration object for the proxy's thread pools. Controls the number of
 * acceptor and worker threads in the Netty
...
public class ProxyServerConfiguration {
  ...
  /**
   * Set the number of client-to-proxy worker threads to create. Worker threads
   * perform the actual processing of client requests. The default value is
   * {@link ServerGroup#DEFAULT_INCOMING_WORKER_THREADS}.
   *
   * @param clientToProxyWorkerThreadSize number of client-to-proxy worker threads
   *        to create
  ...
  /**
   * Set the number of acceptor threads to create. Acceptor threads accept HTTP
   * connections from the client and queue them for processing by client-to-proxy
   * worker threads. The default value is
  ...
  /**
   * Set the number of proxy-to-server worker threads to create. Proxy-to-server
   ...
   *
   * @param proxyToServerWorkerThreadSize number of proxy-to-server worker threads
   *        to create
   * @return this thread pool configuration instance, for chaining
   */
